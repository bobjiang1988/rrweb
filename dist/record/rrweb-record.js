var rrwebRecord = (function () {
    ...
    ***************************************************************************** */
    ...
    var MutationBuffer = (function () {
            ...
            this.emit = function () {
                ...
                var pushAdd = function (n) {
                    ...
                    var parentId = isShadowRoot(n.parentNode)
                        ? mirror.getId(shadowHost)
                        : mirror.getId(n.parentNode);
                    ...
                    case 'childList': {
                        ...
                        m.removedNodes.forEach(function (n) {
                            ...
                            var parentId = isShadowRoot(m.target)
                                ? mirror.getId(m.target.host)
                                : mirror.getId(m.target);
        ...
        MutationBuffer.prototype.init = function (cb, blockClass, blockSelector, maskTextClass, maskTextSelector, inlineStylesheet, maskInputOptions, maskTextFn, recordCanvas, slimDOMOptions, doc, iframeManager, shadowDomManager) {
    ...
    var mutationBuffers = [];
    function initMutationObserver(cb, doc, blockClass, blockSelector, maskTextClass, maskTextSelector, inlineStylesheet, maskInputOptions, maskTextFn, recordCanvas, slimDOMOptions, iframeManager, shadowDomManager, rootEl) {
        var _a, _b, _c;
        var mutationBuffer = new MutationBuffer();
        mutationBuffers.push(mutationBuffer);
        mutationBuffer.init(cb, blockClass, blockSelector, maskTextClass, maskTextSelector, inlineStylesheet, maskInputOptions, maskTextFn, recordCanvas, slimDOMOptions, doc, iframeManager, shadowDomManager);
    ...
    function initObservers(o, hooks) {
        ...
        mergeHooks(o, hooks);
        var mutationObserver = initMutationObserver(o.mutationCb, o.doc, o.blockClass, o.blockSelector, o.maskTextClass, o.maskTextSelector, o.inlineStylesheet, o.maskInputOptions, o.maskTextFn, o.recordCanvas, o.slimDOMOptions, o.iframeManager, o.shadowDomManager, o.doc);
